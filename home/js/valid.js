...
$("#verify_application_mobile_form").on('keyup', function () {
  ...
  var phonenumbernumber = $("input[name=phonenumber]").val();
  var whereabouts = $("input[name=whereabouts]").val();
  var course = $("select[name=course]").val();
  var school = $("input[name=school]").val();
  var grade = $("input[name=grade]").val();
  if (fullname && email && phonenumbernumber && whereabouts && course && school && grade) {
...
$("#download_curriculum_form").on('click', function () {
  ...
  var fullname = $("input[name=fullname]").val();
  var email = $("input[name=email]").val();
  var phonenumbernumber = $("input[name=phonenumbernumber]").val();
  var whereabouts = $("input[name=whereabouts]").val();
  var course = $("select[name=course]").val();
  var school = $("input[name=school]").val();
  var grade = $("input[name=grade]").val();
